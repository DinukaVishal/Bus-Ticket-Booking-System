...
--   support_categories, support_tickets, support_messages,
--   support_ticket_notes, support_ticket_events, ticket_ratings,
--   notifications (reusable), ticket-attachments storage bucket
--
-- Security model:
--   Passenger / Bus Owner -> create & access ONLY their own tickets
--   Staff                 -> access & update assigned tickets only
--   Admin                 -> full CRUD on everything
--
-- Notifications are created automatically by DB triggers/security-definer
-- functions so they can be reused by future modules.
-- =====================================================================
...
-- ---------------------------------------------------------------------
-- 3. support_messages table (conversation thread)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 4. support_ticket_notes table (internal, staff/admin only)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 5. support_ticket_events table (timeline)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 7. notifications table (reusable across modules)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 11. Helper: can_access_ticket
--     Returns true if the given user is the owner, the assigned staff,
--     or an admin for a ticket.
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 12. Trigger: auto-generate ticket number (SUP-01000)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 13. Trigger: maintain resolved_at / closed_at on status change
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 18b. get_staff_users RPC (for admin assignment dropdowns)
--      Returns auth.users ids that have the 'staff' role, joined with
--      their profile display names.
-- ---------------------------------------------------------------------
...
-- Upload path: {ticketId}/{userId}/{filename}
